...
<div class="container">
    ...
    <form action="{{ route('cliente.ventas.store') }}" method="POST" id="ventaForm">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="date" name="fecha_venta" id="fecha_venta" class="form-control" value="{{ now()->format('Y-m-d') }}" readonly>
        </div>
        <div class="form-group">
